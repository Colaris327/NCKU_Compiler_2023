...
%type <s_val> Lit Expression TypeName ExpressionExpr assign_op ID_or_LIT Funcname Parameter Exp Exp1 Exp2 Exp3 Exp4 uexpr AsStmt Operand
%type <s_val> unary_op com_op add_op mul_op shift_op
// %type <s_val> Type
// %type <s_val> DecStmt AssignStmt Block IfStmt ForStmt PrintStmt PrintLNStmt ExpressionStmt Expression assign_op AssignmetExpr Condition ID
// %type <s_val> AND Comp Comp_ comp__ End UnaryExpr PrimaryExpr ExpressionExpr comp_op add_sub_op mul_div_op unary_op Operand Lit IndexExpr
...
Func
    : Funcname '(' {create_symbol(SCOPE + 1); SCOPE++;} Parameter ')' ARROW TypeName '{' GlobalStatementList '}' { 
